...
#
# Dependencies:
#   1. EVENT_TRACKING_BACKENDS and TRACKING_BACKENDS settings:
#        Both are used as a pipeline for transforming events. Logs generated
#        by 'eventtracking' app use EVENT_TRACKING_BACKENDS settings,
#        while logs generated by 'track' app use 'TRACKING_BACKENDS' settings.
#        'caliper_tracking' appends its processor in both the settings which
#        eventually redirects the logs to caliper's processor.
#
