...
#
# Following are the changes made in Django settings by openedx_caliper_tracking app.

# 1. EVENT_TRACKING_BACKENDS settings:
#      It is responsible for logging events of 'eventtracking' app, our
#      'openedx_caliper_tracking' app appends its custom processor
#      ('openedx_caliper_tracking.processor.CaliperProcessor') in the pipeline of
...
#      'openedx_caliper_tracking' replaces the default logging backend with its
#      own custom backend which eventually redirects the logs to
#      openedx_caliper_tracking's processor.
#
#      TRACKING_BACKENDS = {
#        'logger': {
#          'ENGINE': 'openedx_caliper_tracking.processor.CaliperProcessor',
#          'OPTIONS': {
#             'name': 'tracking'
#          }
#        }
