...
def get_certificate_description(mode, certificate_type, platform_name):
    ...
    if mode == 'honor':
        ...
        certificate_type_description = _("An {cert_type} statement of accomplishment signifies that a "
        ...
        certificate_type_description = _("A {cert_type} statement of accomplishment signifies that a "
                                         "learner has agreed to abide by the honor code established by {platform_name} "
                                         "and has completed all of the required tasks for this course under its "
                                         "guidelines. A {cert_type} statement of accomplishment also indicates that the "
        ...
        certificate_type_description = _("An {cert_type} statement of accomplishment demonstrates a high level of "
...
def _update_certificate_context(context, course, user_certificate, platform_name):
    ...
    context['accomplishment_copy_description_full'] = _("successfully completed, received a passing grade, and was "
                                                        ...
                                                        "Statement of Accomplishment in ").format(
        platform_name=platform_name,
        certificate_type=context.get("certificate_type"))
