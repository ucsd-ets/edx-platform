...
# 'edx_caliper_tracking' app allows us to transform Edx event-logs according to
...
#
# Following are the changes made in Django settings by edx_caliper_tracking app.

# 1. EVENT_TRACKING_BACKENDS settings:
#      It is responsible for logging events of 'eventtracking' app, our
#      'edx_caliper_tracking' app appends its custom processor
#      ('edx_caliper_tracking.processor.CaliperProcessor') in the pipeline of
#      'processors' present in 'options' of 'tracking_logs' inside
#      'EVENT_TRACKING_BACKENDS'.
#
# 2. TRACKING_BACKENDS settings:
#      Logs generated by 'track' app use 'TRACKING_BACKENDS' settings.
#      'edx_caliper_tracking' replaces the default logging backend with its
#      own custom backend which eventually redirects the logs to
#      edx_caliper_tracking's processor.
#
#      TRACKING_BACKENDS = {
#        'logger': {
#          'ENGINE': 'edx_caliper_tracking.processor.CaliperProcessor',
#          'OPTIONS': {
#             'name': 'tracking'
#          }
#        }
...
#    'eventtracking' app. The code bellow will handle this.
#
